  ...
  var waypoints = []
    ...
    function optimize() {
      tt.services.calculateRoute({
        key: 'E5TCWBqooqZcaJEkfYVGXtVsSkZ3Qi3R', // Get one for free at developer.tomtom.com
        locations: waypoints,
        routeType: 'shortest',
    ...
    function showMap(center) {
      map = tt.map({
        key: 'E5TCWBqooqZcaJEkfYVGXtVsSkZ3Qi3R',  // Get on for free at developer.tomtom.com
        container: 'map',
        center: center,
        zoom: 13,
        pitch: 25
